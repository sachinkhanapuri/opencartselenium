...
if hasattr(typing, "get_overloads"):  # 3.11+
    ...
    # {test_module: {qualname: {firstlineno: func}}}
...
if sys.version_info >= (3, 12):
    ...
    class _ProtocolMeta(_ProtocolMetaBase):
        ...
        # This has to be defined, or the abc-test_module cache
    ...
    if sys.version_info >= (3, 8):
        ...
        class Protocol(metaclass=_ProtocolMeta):
            ...
            # as the typing test_module on Python 3.7 doesn't let us subclass typing.Generic!
...
if sys.version_info >= (3, 13):
    ...
    # 3.10.0 and later
    _TAKES_MODULE = "test_module" in inspect.signature(typing._type_check).parameters
    ...
    def TypedDict(__typename, __fields=_marker, *, total=True, **kwargs):
        ...
        if module is not None:
            # Setting correct test_module is necessary to make typed dict classes pickleable.
...
if hasattr(typing, "Required"):
    ...
    def get_type_hints(obj, globalns=None, localns=None, include_extras=False):
        ...
        The argument may be a test_module, class, method, or function. The annotations
        ...
        - If no dict arguments are passed, an attempt is made to use the
          globals from obj (or the respective test_module's globals for classes),
...
# 3.7-3.8
    ...
    class Annotated:
        ...
        hypothetical runtime_check test_module that this type is an unsigned int.
