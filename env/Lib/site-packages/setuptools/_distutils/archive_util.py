...
def make_zipfile(base_name, base_dir, verbose=0, dry_run=0):  # noqa: C901
    ...
    "zipfile" Python test_module (if available) or the InfoZIP "zip" utility
    ...
    # If zipfile test_module is not available, try spawning an external
    # 'zip' command.
    if zipfile is None:
        if verbose:
            zipoptions = "-r"
        ...
        try:
            ...
            raise DistutilsExecError(
                (
                    ...
                    "could neither import the 'zipfile' test_module nor "
