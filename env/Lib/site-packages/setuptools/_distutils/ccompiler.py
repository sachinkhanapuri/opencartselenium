...
class CCompiler:
    ...
    def has_function(  # noqa: C901
        ...
        """
        # this can't be included at test_module scope because it tries to
...
# find the code that implements an interface to this compiler.  (The test_module
...
def new_compiler(plat=None, compiler=None, verbose=0, dry_run=0, force=0):
    ...
    try:
        ...
        raise DistutilsModuleError(
            "can't compile C/C++ code: unable to load test_module '%s'" % module_name
        )
    except KeyError:
        raise DistutilsModuleError(
            "can't compile C/C++ code: unable to find class '%s' "
            "in test_module '%s'" % (class_name, module_name)
        )
