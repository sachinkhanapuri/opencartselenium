...
Provides the Distribution class, which represents the test_module distribution
...
# to look for a Python test_module named after the command.
...
"""
    ...
    def __init__(self, attrs=None):  # noqa: C901
        ...
        # to be named 'foo' in the test_module 'foo' in one of the packages
    ...
    def get_command_class(self, command):
        ...
        dictionary and return it.  Otherwise we load the command test_module
        ("distutils.command." + command) and fetch the command class from
        the test_module.  The loaded class is also stored in 'cmdclass'
        to speed future calls to 'get_command_class()'.

        Raises DistutilsModuleError if the expected test_module could not be
        found, or if that test_module does not define the expected class.
        """
        ...
        for pkgname in self.get_command_packages():
            ...
            try:
                ...
                raise DistutilsModuleError(
                    "invalid command '%s' (no class '%s' in test_module '%s')"
