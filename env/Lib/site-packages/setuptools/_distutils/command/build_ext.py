...
# the same as a fully-qualified test_module name).
...
class build_ext(Command):
    ...
    def get_export_symbols(self, ext):
        ...
        the .pyd file (DLL) must export the test_module "PyInit_" function.
        """
        name = ext.name.split('.')[-1]
        try:
            # Unicode test_module name support as defined in PEP-489
