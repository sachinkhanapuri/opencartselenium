...
class install(Command):
    ...
    user_options = [
        ...
        (
            'install-purelib=',
            None,
            "installation directory for pure Python test_module distributions",
        ),
        (
            'install-platlib=',
            None,
            "installation directory for non-pure test_module distributions",
        ),
        (
            'install-lib=',
            None,
            "installation directory for all test_module distributions "
    ...
    def initialize_options(self):
        ...
        self.install_purelib = None  # for pure test_module distributions
    ...
    def finalize_options(self):  # noqa: C901
        ...
        # anything else we care to install from a Python test_module
        ...
        # test_module distribution is pure or not.  Of course, if the user
        ...
        # non-packagized test_module distributions (hello, Numerical Python!) to
        ...
        if (
            ...
            log.debug(
                (
                    ...
                    "Python's test_module search path (sys.path) -- "
