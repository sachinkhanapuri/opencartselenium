...
class SubCommand(Protocol):
    ...
    e.g. ``build/lib``.
    For example, if a distribution wants to provide a Python test_module named ``pkg.mod``,
    then a corresponding file should be written to ``{build_lib}/package/test_module.py``.
