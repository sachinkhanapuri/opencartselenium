...
class Module:
    '''
    Executable test_module information
    '''
    #: Name of the test_module.
    name: str

    #: UUID of the test_module.
    uuid: str

    #: Base address where the test_module is loaded into memory. Encoded as a decimal
    #: or hexadecimal (0x prefixed) string.
    base_address: str

    #: Size of the test_module in bytes.
    size: float
