...
def execute_wasm_evaluator(
    ...
    '''
    Execute a Wasm Evaluator test_module on a given call frame.

    **EXPERIMENTAL**

    :param call_frame_id: WebAssembly call frame identifier to evaluate on.
    :param evaluator: Code of the evaluator test_module.
    :param timeout: **(EXPERIMENTAL)** *(Optional)* Terminate execution after timing out (number of milliseconds).
    :returns: A tuple with the following items:
...
class ScriptFailedToParse:
    ...
    #: True, if this script is ES6 test_module.
    is_module: typing.Optional[bool]
    #: This script length.
    length: typing.Optional[int]
    #: JavaScript top stack frame of where the script parsed event was triggered if available.
    stack_trace: typing.Optional[runtime.StackTrace]
    #: If the scriptLanguage is WebAssembly, the code section offset in the test_module.
...
class ScriptParsed:
    ...
    #: The language of the script.
    script_language: typing.Optional[debugger.ScriptLanguage]
    #: If the scriptLanguage is WebASsembly, the source of debug symbols for the test_module.
