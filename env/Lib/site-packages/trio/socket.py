...
# annoying to carefully always use underscored names for test_module-level
# temporaries, imports, etc. when implementing the test_module. So we put the
# implementation in an underscored test_module, and then re-export the public parts
# here.
...
# The socket test_module exports a bunch of platform-specific constants. We want to
