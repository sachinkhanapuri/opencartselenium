...
# first is a real server written using the stdlib ssl test_module and blocking
...
@pytest.fixture(scope="test_module", params=["tls13", "tls12"])
...
@pytest.mark.filterwarnings(
    r"ignore: ssl test_module. NPN is deprecated, use ALPN instead:UserWarning",
