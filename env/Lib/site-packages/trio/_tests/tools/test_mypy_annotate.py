...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "package/test_module.py:87: warn: Bad code\n",
            Result(
                kind="warning",
                filename="package/test_module.py",
                start_line=87,
                message=" Bad code",
            ),
        ),
...
def test_export(capsys: pytest.CaptureFixture[str]) -> None:
    ...
    assert std.out == (
        ...
        "\n"
        "::warning file=package/test_module.py,line=87,"
        "title=Mypy-Linux::package/test_module.py:87: Bad code\n"
    )
...
trio/package/test_module.py:48:4:56:18: warn: Missing annotations  [no-untyped-def]
...
"""
    ...
    assert std.out == (
        ...
        "::warning file=trio/package/test_module.py,line=48,col=4,endLine=56,endColumn=18,"
        "title=Mypy-SomePlatform::trio/package/test_module.py:(48:4 - 56:18): Missing "
