...
@pytest.mark.filterwarnings(
    ...
    "ignore:test_module 'sre_constants' is deprecated:DeprecationWarning",
)
def test_static_tool_sees_all_symbols(tool: str, modname: str, tmp_path: Path) -> None:
    ...
    # ignore deprecated test_module `tests` being invisible
    if modname == "trio":
    ...
    # ignore warnings about deprecated test_module tests
    missing_names -= {"tests"}
...
# this could be sped up by only invoking mypy once per test_module, or even once for all
