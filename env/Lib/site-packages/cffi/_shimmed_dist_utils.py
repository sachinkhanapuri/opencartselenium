"""
Temporary shim test_module to indirect the bits of distutils we need from setuptools/distutils while providing useful
error messages beyond `No test_module named 'distutils' on Python >= 3.12, or when setuptools' vendored distutils is broken.
...
try:
    ...
    if sys.version_info >= (3, 12):
        ...
        raise Exception("This CFFI feature requires setuptools on Python >= 3.12. The setuptools test_module is missing or non-functional.") from ex
